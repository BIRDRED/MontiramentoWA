...
@ManagedBean
@SessionScoped
public class DashboardSOUBLYBean implements Serializable {
	...
	public DashboardSOUBLYBean() {
		 ...
		 GeneralBean gb = new GeneralBean();
			 ...
			 try {
				...
				for(ReportData rd : dbr.getDashboard("b2w-suba", date).getReport().getData()){
					//Taxas de Relatório
	...
	public static void main(String[] args) {
		DashboardSOUBLYBean daly =  new DashboardSOUBLYBean();
