...
@ManagedBean
@SessionScoped
public class EparSOUBBean implements Serializable {
	...
	public EparSOUBBean() throws IOException, InterruptedException {
	...
	private void populateData() throws IOException, InterruptedException {
		EparSOUBBean epar = new EparSOUBBean();
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		EparSOUBBean eparb = new EparSOUBBean();
